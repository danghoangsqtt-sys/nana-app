...
import { EyeState, UserSettings, UserLocation, ChatMessage } from '../types';

export const useGeminiLive = (settings: UserSettings, location: UserLocation | null) => {
  ...
  const connect = useCallback(() => {
    ...
    service.connect(settings, location, 'assistant');
